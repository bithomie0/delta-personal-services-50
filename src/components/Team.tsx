              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <div className="shrink-0 flex justify-center">
                  <Avatar className="h-48 w-48 rounded-full bg-gray-100">
                    {!gladysImageError ? <AvatarImage src="/lovable-uploads/c00b4304-005f-441e-b559-f239d786c71d.png" alt="Gladys Lufen" onError={handleGladysImageError} className="object-cover object-center" /> : <AvatarImage src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?auto=format&fit=crop&w=300&h=300" alt="Gladys Lufen" className="object-cover object-center" />}
          ...
          <Card className="overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 border-0">
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <div className="shrink-0 flex justify-center">
                  <Avatar className="h-48 w-48 rounded-full bg-gray-100">
                    {!jacklineImageError ? <AvatarImage src="/lovable-uploads/3b711b06-13ad-4492-9f46-5e5821f1a0ae.png" alt="Jackline Conley" onError={handleJacklineImageError} className="object-cover object-top" /> : <AvatarImage src="https://images.unsplash.com/photo-1581091226825-6a2a5aee158?auto=format&fit=crop&w=300&h=300" alt="Jackline Conley" className="object-cover object-top" />}
