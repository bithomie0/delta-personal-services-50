...
const resources = {
  en: {
    translation: {
      ...
      "gladys_description": "Connects nursing professionals with German opportunities through her understanding of both healthcare systems.",
      "jackline_description": "Ensures smooth transitions for healthcare professionals joining German teams with her entrepreneurial approach.",
  ...
  de: {
    translation: {
      ...
      "gladys_description": "Verbindet Pflegefachkräfte mit deutschen Möglichkeiten durch ihr Verständnis beider Gesundheitssysteme.",
      "jackline_description": "Sorgt mit ihrem unternehmerischen Ansatz für einen reibungslosen Übergang für Gesundheitsfachkräfte in deutsche Teams.",
