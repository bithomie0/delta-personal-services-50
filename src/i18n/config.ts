...
const resources = {
  en: {
    translation: {
      ...
      "gladys_description": "Gladys is a qualified nurse with extensive experience in the healthcare sector. She understands both international and German healthcare systems, helping us connect the right professionals with the right opportunities.",
      "jackline_description": "Jackline uses her entrepreneurial skills to connect healthcare professionals with German institutions. With her background in childcare services, she ensures smooth transitions for all professionals joining German healthcare teams.",
  ...
  de: {
    translation: {
      ...
      "gladys_description": "Gladys ist eine qualifizierte Krankenschwester mit umfangreicher Erfahrung im Gesundheitssektor. Sie versteht sowohl internationale als auch deutsche Gesundheitssysteme und hilft uns dabei, die richtigen Fachkräfte mit den passenden Stellen zu verbinden.",
      "jackline_description": "Jackline nutzt ihre unternehmerischen Fähigkeiten, um Gesundheitsfachkräfte mit deutschen Einrichtungen zu verbinden. Mit ihrem Hintergrund im Bereich Kinderbetreuung sorgt sie für einen reibungslosen Übergang für alle Fachkräfte, die sich deutschen Gesundheitsteams anschließen.",
