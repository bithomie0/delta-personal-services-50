...
const resources = {
  en: {
    translation: {
      ...
      "gladys_description": "With extensive experience in international recruitment, Gladys leads our team connecting nursing professionals with German opportunities. Her dual expertise as a healthcare system specialist and registered nurse ensures our recruitment process is informed by clinical insights.",
      "jackline_description": "Jackline brings her entrepreneurial vision to finding perfect matches between healthcare professionals and German institutions. Her background in childcare placement adds valuable insight to our service portfolio, ensuring smooth transitions for all parties.",
  ...
  de: {
    translation: {
      ...
      "gladys_description": "Mit umfangreicher Erfahrung in der internationalen Rekrutierung führt Gladys unser Team bei der Vermittlung von Pflegefachkräften. Ihre Expertise als Gesundheitssystem-Spezialistin und examinierte Krankenschwester bereichert unseren Rekrutierungsprozess mit wertvollen klinischen Einblicken.",
      "jackline_description": "Jackline bringt ihre unternehmerische Vision ein, um die perfekte Vermittlung zwischen Gesundheitsfachkräften und deutschen Institutionen zu finden. Ihr Hintergrund in der Kinderbetreuungsvermittlung ergänzt unser Dienstleistungsportfolio und sorgt für einen reibungslosen Übergang aller Beteiligten.",
