...
const resources = {
  en: {
    translation: {
      ...
      "expert_team_desc": "Led by professionals with firsthand experience in healthcare and international recruitment.",
      ...
      "language_courses": "German language courses (B2 level)",
      ...
      "prescreened": "Pre-screened candidates with 4-year Bachelor's degree",
      ...
      "german_course": "German Language Training (B2 level)",
  ...
  de: {
    translation: {
      ...
      "expert_team_desc": "Geführt von Fachleuten mit direkter Erfahrung im Gesundheitswesen und in der internationalen Rekrutierung.",
      ...
      "language_courses": "Deutschkurse (B2-Niveau)",
      ...
      "prescreened": "Vorgeprüfte Kandidaten mit 4-jährigem Bachelor-Abschluss",
      ...
      "german_course": "Deutschsprachtraining (B2-Niveau)",
